...
function askToWipe() {
  confirmation.require({
    message: 'Профиль, дневник и история веса будут стёрты с этого телефона. Данные хранятся только здесь, восстановить их будет неоткуда — если копия ещё не выгружена, сначала сделай её.',
    acceptLabel: 'Стереть',
    accept: () => {
      void wipe();
    },
